...
public class SmithAITabCompleter implements TabCompleter {
    ...
    private static final List<String> SUBS = Arrays.asList(
        "spawn", "despawn", "follow", "stay", "goto", "do", "ask", "tasks", "clear", "info", "equip", "unequip", "debug", "health", "stop", "status", "model", "version", "reload", "train", "feedback", "feedback-list", "report", "reports", "memory", "inventory", "give", "list", "help", "teleport", "skin", "config", "export"
    );
